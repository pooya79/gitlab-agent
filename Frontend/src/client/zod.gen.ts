...
export const zBotRead = z.object({
    ...
    llm_top_p: z.optional(z.number()).default(0.95),
...
export const zGitlabSettingsOut = z.object({
    gitlab_base: z.union([z.string(), z.null()]),
    gitlab_client_id: z.union([z.string(), z.null()]),
...
export const zGitlabSettingsUpdate = z.object({
    gitlab_base: z.optional(z.union([z.string(), z.null()])),
    gitlab_client_id: z.optional(z.union([z.string(), z.null()])),
    gitlab_client_secret: z.optional(z.union([z.string(), z.null()])),
    gitlab_webhook_ssl_verify: z.optional(z.union([z.boolean(), z.null()])),
});
...
export const zLlmModelInfo = z.object({
    ...
    input_token_cost: z.optional(z.number()).default(0),
    output_token_cost: z.optional(z.number()).default(0),
 ...
 * Successful Response
 */
export const zGetGitlabSettingsApiV1AdminSettingsGitlabGetResponse =
    zGitlabSettingsOut;
 ...
 * Successful Response
 */
export const zPatchGitlabSettingsApiV1AdminSettingsGitlabPatchResponse =
    zGitlabSettingsOut;

export const zListLlmConfigsApiV1AdminSettingsLlmsGetData = z.object({
    body: z.optional(z.never()),
    path: z.optional(z.never()),
    query: z.optional(z.never()),
});
...
/**
 * Response List Llm Configs Api V1 Admin Settings Llms Get
 *
 * Successful Response
 */
export const zListLlmConfigsApiV1AdminSettingsLlmsGetResponse = z.record(
    z.string(),
    zLlmModelInfo,
);

export const zAddUpdateLlmConfigApiV1AdminSettingsLlmsPostData = z.object({
    body: zLlmModelInfo,
    path: z.optional(z.never()),
    query: z.optional(z.never()),
});
 ...
 * Successful Response
 */
export const zAddUpdateLlmConfigApiV1AdminSettingsLlmsPostResponse =
    zLlmModelInfo;

export const zDeleteLlmConfigApiV1AdminSettingsLlmsModelNameDeleteData =
    z.object({
        body: z.optional(z.never()),
        path: z.object({
            model_name: z.string(),
